...
Delivered extension: [Android Emulator contract](product-specs/android-emulator.md) and its [completed ExecPlan](exec-plans/completed/android-emulator-lease.md).
