...
source_sha256: 0ee49731313e9e1707b513c166a5ec1adaf7f6b610f5fea6b7bf3307d95391af
---
...
同じ物理マシンの二つの worker root を使う実 TLS の Linux 証拠は 21.406s で成功しました。
Windows/macOS の native と、物理的な複数 host・VM の証拠はまだありません。
