...
- [ ] Run focused regressions, full harness/race and native CI; review integrated changes.
- [ ] Push fixes, reply to and resolve each addressed thread, archive this bilingual plan.
