...
func TestArchitectureBoundaries(t *testing.T) {
	for _, tc := range []struct {
		...
		{"controlplane", "internal/runtime/process", true},
		{"controlplane/scheduler", "internal/app", true},
		{"controlplane/store", "internal/store/sqlite", true},
		{"controlplane", "internal/worker", true},
		{"controlplane", "os/exec", true},
		{"controlplane", "internal/remotesource", true},
		{"controlplane", "internal/controlplane/protocol", false},
		{"controlplane", "internal/blobstore", false},
		{"controlplane/protocol", "internal/app", true},
		{"controlplane/protocol", "encoding/json", false},
		{"worker", "internal/runtime/android", true},
		{"worker", "internal/cli", true},
		{"worker", "internal/controlplane/store", true},
		{"worker", "internal/app", false},
		{"app", "internal/controlplane/protocol", true},
		{"app", "internal/worker", true},
		{"store/sqlite", "internal/controlplane/store", true},
		{"worker", "internal/remotesource", false},
		{"remotesource", "internal/runtime/compose", true},
		{"remotesource", "internal/controlplane/protocol", true},
		{"remotesource", "internal/source/gitcli", false},
		{"blobstore", "internal/app", true},
		{"instance", "internal/worker", true},
